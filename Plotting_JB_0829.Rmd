...
```{r}
dotchart(CO2$uptake) # separate out data by plant origin
...
# Characteristics of good data plots:
  + A purpose, clearly defined set of variables, and a message to convey. 
  + Succinct and uncluttered so as to allow easy interpretation of the purpose. 
  + Comprehensive, representing the data accurately and fairly.  

Let's now take a closer look at the different plot types using our CO2 dataset to ask biological questions and explore relationships.
...
## Exploring data with biological questions in mind.
...
Tip: before adding color to any plot to show species differences, make sure to change your current color palette, as it currently only contains two colors if you were following along above.  
